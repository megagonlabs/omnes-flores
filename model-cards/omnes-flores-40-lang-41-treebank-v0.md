...
- The `LS` component takes documents as input, and outputs results of `language identification` and `sentence segmentation` tasks
  - Corresponding model is [omnes-flores-40-lang-41-treebank-v0-ls](https://huggingface.co/megagonlabs/omnes-flores-40-lang-41-treebank-v0-ls).
- The `WX` component takes a sentence and its language, and outputs results of `word segmentation` and `language-specific part-of-speech tagging` tasks
  - Corresponding model is [omnes-flores-40-lang-41-treebank-v0-wx](https://huggingface.co/megagonlabs/omnes-flores-40-lang-41-treebank-v0-wx).
...
![omnes-flores-40-lang-41-treebank-v0-eval.png](https://github.com/megagonlabs/omnes-flores/raw/main/docs/images/omnes-flores-40-lang-41-treebank-v0-eval.png)

See the [NLP2026 paper](https://github.com/megagonlabs/omnes-flores/raw/main/docs/images/NLP2026_TS2-16_paper.pdf) and its [poster material](https://github.com/megagonlabs/omnes-flores/raw/main/docs/images/NLP2026_TS2-16_poster.pdf) (written in Japanese) for details.
